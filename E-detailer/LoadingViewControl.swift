...
class ActivityViewController: UIViewController {
    ...
    func text(text: String) {
        activityView.text(text: text)
    }
    
    func show(existingUiViewController: UIViewController) {
...
private class ActivityView: UIView {
    ...
    override func layoutSubviews() {
        ...
        let messageLabelSize = messageLabel.sizeThatFits(CGSize(width:160.0, height: CGFloat.greatestFiniteMagnitude))
